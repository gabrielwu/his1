...
<?php if($userType != 'p'): ?><a href="<?php echo ($root); ?>/patient/index"  target="main">病历查询</a>
			<a href="<?php echo ($root); ?>/patient/add"    target="main">病历新建</a><?php endif; ?>
...
<?php if(($userType == 'd') OR ($adminType > '0')): ?><div>
	    <a href="<?php echo ($root); ?>/doctor/index" target="main"><h3>医生信息</h3></a>
    </div><?php endif; ?>
<?php if($adminType >= '0'): ?><div>
	    <h3>数据字典</h3>
	    <p class="">
...
<?php if($adminType > '0'): ?><a href="<?php echo ($root); ?>/diagnosis/index"      target="main">诊断</a>
			...
			<a href="<?php echo ($root); ?>/operationType/index"  target="main">手术</a><?php endif; ?>		
	    </p>
    </div><?php endif; ?>
    <div>
	    <h3>帐号管理</h3>
